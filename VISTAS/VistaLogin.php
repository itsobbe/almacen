...
<body>
    <div class="login-dark" style="height:722px;">
        <form method="post" action="../CONTROLADORES/ControladorInicioSesion.php"autocomplete="off">
            <h2 class="sr-only">Login Form</h2>
            <h3 style="text-align: center;">Inicio de sesión</h3>
            <div class="illustration"><i class="icon ion-ios-locked-outline"></i></div>
            <div class="form-group"><input class="form-control" type="text" name="nombre" placeholder="Nombre" autofocus="" required></div>
