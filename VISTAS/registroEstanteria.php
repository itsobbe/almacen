            ...
            <div class="page-content-wrapper">
                <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                <h1>Registro de estantería</h1>
                            </div>
                        </div>
                    </div>
                    <div class="align-items-center m-auto" style="width:589px;">
                        <form class="d-block" name="miFormulario" action="../CONTROLADORES/ControladorAltaEstanteria.php" autocomplete="off">
                            <div class="form-row">
                                <div class="col">
                                    <label>Código</label>
                                    <div class="input-group ">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" name="etiqueta" value="ES" id="basic-addon1">ES</span>
                                        </div>
                                ...
                                <div class="col">
                                    <div class="form-group"><label>Capacidad Lejas</label><input class="form-control" id="capacidadLejas" min="1" maxlength="5" name="capacidadLejas" type="number" required=""></div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group"><label>Pasillo</label>
                                        <select class="form-control" id="pasillosDisponibles" name="pasillosDisponibles" onchange="numeros(this.value)" required="">
                                            <optgroup label="Pasillos disponibles">
                                                <option value="nulo" selected="selected">
                                                    Elige el pasillo
                                                </option>
                                                <?php foreach ($pasillos as $objeto) { ?>
                                                    <option value="<?php echo $objeto->getId() ?>">
                                                        <?php echo $objeto->getLetra() ?>
                                                    </option>
                                                    <?php
                                                }
                                                ?>
                                ...
                                <div class="col">
                                    <div class="form-group"><label>Letra</label>
                                        <select class="form-control" id="numerosDisponibles" name="numerosDisponibles" required="">
                                            <optgroup label="Números disponibles">
                                                <option value="null" selected="selected">Elige Número</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                </div>
